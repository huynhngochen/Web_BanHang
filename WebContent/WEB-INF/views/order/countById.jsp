...
<div class="container-fluid">
	...
	<div class="row text-center">
		<div class="box">
			<form:form action="admin/order/countById.htm" method="post">
				...
				<input style="width: 175px" type="date" name="date1" id="datefield"
					max="">
				<b>Đến Ngày</b>
				<input type="date" name="date2" max="" id="datefield1">
				<br>
				<button style="position: relative; margin-top: 20px;" type="submit"
...
$(document).ready(function(){
	...
	for(var i =0; i<json.length; i++){
		newDate.push(String(json[i].created));
...
new Chart(document.getElementById("line-chart"), {
	  ...
	  options: {
	    title: {
	      display: true,
	      text: 'Thống kê doanh thu bán hàng của sản phẩm'
	    }
	  }
	});
