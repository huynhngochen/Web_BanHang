		...
		<div class="col-lg-12">
			<div class="box white-box analytics-info" style="padding: 22px;">
				<div style="margin-bottom: 40px;">
					<h2 class="show_date">THỐNG KÊ LỢI NHUẬN SẢN PHẨM TỪ <f:formatDate pattern="dd-MM-yyyy"
											value="${date_start }" /> 
						ĐẾN 
					 <f:formatDate pattern="dd-MM-yyyy"
											value="${date_finish}" /></h2>
					<h2 class="not_show">THỐNG KÊ LỢI NHUẬN SẢN PHẨM</h2>
				</div>
				<table class="table no-wrap table-hover">
					...
					<tbody>
						<c:forEach var="item" items="${listProfitProduct}">
							<tr class="text-center">
								...
								<td><f:formatNumber minFractionDigits="0"
										value="${item.totalBuy}" type="number" /></td>
								<td><f:formatNumber minFractionDigits="0"
										value="${item.totalImport}" type="number" /></td>
								<td><f:formatNumber minFractionDigits="0"
										value="${item.totalBuy - item.totalImport}"
										type="number" /></td>
							</tr>
						</c:forEach>
					</tbody>
